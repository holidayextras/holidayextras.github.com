...
Remember that each time you add a peice of functionality, you have to kill your server and run `node pathToMyServerFile/server.js` again. Alternatively look into the node module called “Nodemon”.
...
```
This route is saying, if we have a name value in the query string, respond in the way specified. So now if you go to `http://localhost:3000/getName?name=Harley` you will see “Hello, my name is Harley.” and will see “I don’t know your name.” should you not pass a name in the query string.
